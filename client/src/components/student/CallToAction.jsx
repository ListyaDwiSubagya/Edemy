...
const CallToAction = () => {
  return (
    ...
    px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Commodi qui consectetur illo, deserunt molestias fugiat esse veniam ea cum! Velit!</p>
