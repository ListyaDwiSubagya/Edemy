...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLecture,calculateChapterTime, calculateCourseDuration} = useContext(AppContext)
  ...
  return courseData ? (
    <>
      ...
      md:px-36 px-8 md:pt-20 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:text-base text-xs' 
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Listya</span></p>
                      ...
                      border-t border-gray-300'>
                        {chapter.chapterContent.map((lecture, i) => (
                          <li key={i} className='flex items-start gap-2 py-1'>
                            <img src={assets.play_icon} alt="play icon" className='
                            w-4 h-4 mt-1'/>
